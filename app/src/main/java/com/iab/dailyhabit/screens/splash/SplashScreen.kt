...
@Composable
fun SplashScreen()  {
    // Controlar la visibilidad de los elementos para animarlos
    ...
    Box(
        modifier = Modifier
            .fillMaxSize()
            .background(Color.Black) // Fondo negro liso
    ) {
        Column(
            modifier = Modifier
                .fillMaxSize()
            ...
            // Título en la parte superior con animación
            AnimatedVisibility(
                visible = showContent,
            ...
            AnimatedVisibility(
                ...
                Box(
                    modifier = Modifier
                        .size(350.dp)
                        .background(
                            Color.Black, // Fondo negro circular
                            shape = CircleShape
                        ),
